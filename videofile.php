...
$string['modulename_help'] = 'Any video uploaded here can be restricted to only those groups you select (such as convenors and teachers only). This is intended for more sensitive material or for assessed student work for review by staff. Videos uploaded here will be hosted on Kent servers and will not be rolled over.';
